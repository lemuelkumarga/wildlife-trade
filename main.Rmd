...
Consumers are countries that demand wildlife goods. They are identified by taking the top 33% percentile of import percentages.

Please scroll through the icons below to find out more about the top 5 consumers:

`r get_players((consumers %>% head(5))$index,get_color("red"))`

#### Dealers

Dealers are countries that neither consume nor supply wildlife goods. They act as intermediaries between suppliers and consumers and are identified by taking the middle 33% of import percentages.
...
Suppliers are countries that provide for wildlife goods. They are identified by taking the bottom 33% of import percentages.

Please scroll through the icons below to find out more about the top 5 suppliers:

`r get_players((suppliers %>% head(5))$index,get_color("purple"))`
