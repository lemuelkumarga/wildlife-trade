...
By scrolling through the chart above, the <span class="hl yellow-text">Anthozoa</span> class account for close to <span class="hl yellow-text">33%</span> of the total trades. Some examples of species belonging to this class are soft and hard corals. The well-publicized <span class="hl blue-text">African Elephant</span>, belonging to the <span class="hl blue-text">Mammalia</span> class, interestingly account for less than 0.4% of the total trades.
...
`r get_players((dealers %>% head(5))$index,heading_color, type="Transits", disclaimers=list("FR"=c("European Eel"="Due to missing black market exports, France is considered an intermediary stop for European Eels, even though they originate from the country. See Limitations.")))`
...
* <span class="hl">Consumers</span> are countries which generate the demand of wildlife. It is important to educate citizens in these countries to stop using wildlife products. The top 5 consumers are `r gsub(", Republic of", "", paste0(sprintf('<span class="hl">%s</span>',(consumers %>% head(5))$NAME), collapse = ", "))`.
* <span class="hl">Dealers</span> are countries which connect suppliers and consumers. More stringent measures can be set up in the trading ports to reduce endangered wildlife trading. The top 5 dealers are `r paste0(sprintf('<span class="hl">%s</span>',(dealers %>% head(5))$NAME), collapse = ", ")`.
...
* <span class="hl">Species-Specific Fixes</span>: The methods in pre-processing are one-size-fits-all and favor expediency over accuracy. By fixing each trade according to individual species's characteristics (such as weight), we can obtain more accurate transformations of the terms into animal counts.
